...
export default function Home() {
    ...
    return (
        <div ref={containerRef}>
            ...
            <section className="hero">
                ...
                <div className="hero-content">
                    ...
                    <p className="hero-sub">
                        ...
                        bancos tradicionales. Con <strong style={{color: "var(--text)"}}>verificación IA + AML on-chain</strong> en
                    ...
                    <div className="hero-stack" aria-label="Stack tecnológico">
                        <span className="hero-stack-label">Stack</span>
                        <a className="hero-stack-pill" href="https://www.anthropic.com/claude" target="_blank" rel="noreferrer" title="Claude — verificación IA del KYB">
                            {/* eslint-disable-next-line @next/next/no-img-element */}
                            <img src="/claudelogo.png" alt="Claude" />
                            <span>Claude</span>
                        </a>
                        <a className="hero-stack-pill" href="https://www.avax.network" target="_blank" rel="noreferrer" title="Avalanche — capa de liquidación on-chain">
                            {/* eslint-disable-next-line @next/next/no-img-element */}
            ...
            {/* ===== Promo cards (Claude / Avalanche / WavyNode) — moved up so the compliance stack is visible before the business model ===== */}
